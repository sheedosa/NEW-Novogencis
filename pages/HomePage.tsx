  ...
  return (
    <div className={`relative ${className}`}>
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 mb-0.5">
              <span className="text-xl md:text-2xl font-medium text-obsidian">5.0</span>
            ...
            <p className="text-2xs font-medium text-hint text-muted">Google Reviews</p>
          </div>
      ...
      <div className="absolute -bottom-6 -right-6 z-20 bg-white p-3 md:p-4 rounded-2xl shadow-xl border border-primary/10 animate-float hidden md:flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="text-2xs font-medium text-hint text-muted">Clinical Setting</span>
          <span className="text-xs font-bold text-obsidian">Doctor-Led Care</span>
        </div>
      </div>
    </div>
  );
...
const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="animate-fade-in overflow-x-hidden selection:bg-primary/20">
        ...
        <div className="flex flex-col lg:flex-row gap-12 md:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 md:gap-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/5 text-primary border border-primary/10 w-fit mx-auto lg:mx-0 animate-fade-in">
              <Stethoscope size={18} />
              <span className="text-[10px] md:text-[11px] font-medium uppercase tracking-[0.2em]">Hair Loss Specialists</span>
            </div>

            <h1 className="text-obsidian text-4xl xs:text-5xl sm:text-7xl lg:text-8xl font-medium leading-[1.05] tracking-tight animate-fade-up" style={{ animationDelay: '150ms' }}>
            ...
            <p className="text-muted text-base md:text-xl leading-relaxed max-w-[560px] mx-auto lg:mx-0 opacity-0 animate-fade-up" style={{ animationDelay: '250ms' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start opacity-0 animate-fade-up" style={{ animationDelay: '350ms' }}>
              <button 
                ...
                className="group relative bg-primary text-clinical-dark px-10 py-3.5 rounded-full text-base font-medium shadow-2xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden"
              >
                <span className="relative z-10 uppercase group-hover:text-white transition-colors duration-500">Start Your Journey</span>
                <div className="absolute inset-0 bg-obsidian translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out" />
              </button>
              <button 
                onClick={() => onNavigate(Page.Treatments)}
                className="border-2 border-primary/20 hover:border-primary text-obsidian px-10 py-3.5 rounded-full text-base font-medium transition-all duration-300 hover:bg-white active:scale-95 shadow-lg shadow-primary/5 uppercase"
              >
                Treatments
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
            {[
              ...
              <div key={idx} className="flex flex-col items-center md:items-start text-center md:text-left group animate-fade-up" style={{ animationDelay: `${idx * 100}ms` }}>
                <div className="w-14 h-14 md:w-16 md:h-16 bg-cream rounded-2xl flex items-center justify-center text-primary mb-6 md:mb-8 group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-sm">
                  <span className="material-symbols-outlined text-2xl md:text-3xl font-light">{item.icon}</span>
                </div>
                <span className="text-[10px] font-medium uppercase tracking-[0.3em] text-accent-gold mb-3">{item.label}</span>
                <h3 className="text-xl md:text-2xl font-medium mb-4 text-obsidian tracking-tight leading-snug">{item.title}</h3>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-20">
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-24">
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="absolute -bottom-8 -right-4 md:-right-8 z-20 bg-obsidian p-6 rounded-3xl shadow-2xl border border-primary/20 animate-fade-up max-w-[200px]">
                <div className="flex flex-col gap-2">
                  <span className="text-primary font-medium text-[10px] uppercase">IMCAS 2025</span>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6 md:gap-8">
              <div className="flex flex-col gap-4">
                <span className="text-primary font-medium text-[10px] md:text-xs uppercase tracking-[0.4em] animate-fade-in">Clinical Excellence</span>
                <h2 className="text-4xl md:text-6xl font-medium text-obsidian tracking-tight leading-[1.1]">
                  World-Leading <br className="hidden md:block" />
                  <span className="text-primary italic font-serif">PRP Technology.</span>
                </h2>
                <h3 className="text-base md:text-xl font-bold text-muted max-w-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 pt-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4 p-4 rounded-2xl bg-cream border border-primary/5 hover:border-primary/20 transition-all duration-300 group">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-[10px] md:text-xs font-medium text-obsidian uppercase">{stat.title}</span>
                      <span className="text-[11px] text-muted leading-relaxed font-medium">{stat.detail}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-20">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl md:text-6xl font-medium tracking-tight leading-[1.1] mb-4 md:mb-6">
                World-Class <span className="text-primary italic font-serif">Treatments.</span>
              </h2>
              <p className="text-muted text-base md:text-xl">Cutting-edge regenerative protocols tailored for your scalp health.</p>
            </div>
            <button 
              onClick={() => onNavigate(Page.Treatments)}
              className="text-primary font-medium uppercase text-[10px] md:text-sm flex items-center gap-2 group transition-all"
            >
              VIEW ALL TREATMENTS 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={idx} className="premium-card p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] flex flex-col gap-6 group cursor-pointer animate-fade-up" style={{ animationDelay: `${idx * 150}ms` }} onClick={() => onNavigate(Page.Treatments)}>
                <span className="text-2xs font-medium text-hint text-accent-gold/60">{item.cat}</span>
                <h3 className="text-xl md:text-2xl font-medium tracking-tight leading-tight group-hover:text-primary transition-colors duration-300">{item.title}</h3>
                <p className="text-muted leading-relaxed text-sm md:text-base">{item.desc}</p>
                <div className="mt-auto pt-6 flex justify-between items-center border-t border-gray-50">
                  <span className="text-[10px] md:text-xs font-bold text-obsidian group-hover:translate-x-2 transition-transform duration-300 uppercase">LEARN MORE</span>
      ...
      {/* Assessment CTA */}
      <section className="px-4 md:px-10 lg:px-20 py-16 md:py-32 bg-cream">
        <div className="max-w-[1200px] mx-auto bg-obsidian rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-20 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10 md:gap-16">
            <div className="w-full lg:w-3/5 text-center lg:text-left">
              <span className="text-primary font-medium uppercase tracking-[0.4em] text-[10px] mb-4 md:mb-6 block">START YOUR JOURNEY</span>
              <h2 className="text-3xl md:text-6xl font-medium text-white mb-6 md:mb-8 leading-[1.1] tracking-tight">
              ...
              <button 
                onClick={() => onNavigate(Page.Assessment)}
                className="bg-primary text-clinical-dark px-8 py-3.5 rounded-full font-bold text-[11px] md:text-sm uppercase hover:bg-white hover:scale-105 active:scale-95 transition-all duration-300 shadow-lg shadow-primary/10"
              >
      ...
      <section ref={marqueeSectionRef} className="py-12 md:py-32 bg-cream/50 overflow-hidden relative">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-20">
          <div className="text-center mb-10 md:mb-20">
            <span className="text-primary font-medium text-[10px] md:text-xs uppercase tracking-[0.4em] block mb-3 md:mb-4 animate-fade-in">
              Client Experiences
            </span>
            <h2 className="text-3xl md:text-6xl font-medium text-obsidian tracking-tight leading-[1.1] mb-4 md:mb-6 [word-spacing:0.12em]">
                ...
                <div key={idx} className="w-[260px] sm:w-[300px] md:w-[450px] shrink-0 px-3 md:px-5">
                  <div className="premium-card p-5 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] flex flex-col gap-3 md:gap-6 group h-full shadow-2xl shadow-primary/5 bg-white border border-primary/5">
                    ...
                    <div className="relative">
                      <Quote size={64} className="text-primary/10 absolute -top-4 -left-2 md:-top-8 md:-left-12 pointer-events-none hidden md:block" />
                      <Quote size={32} className="text-primary/10 absolute -top-4 -left-2 pointer-events-none md:hidden" />
                      <p className="text-muted italic text-[14px] md:text-lg lg:text-xl leading-relaxed relative z-10 font-serif">
                        "{t.review}"
                      </p>
                    </div>

                    <div className="mt-auto pt-4 md:pt-6 border-t border-gray-50 flex items-center gap-3 md:gap-4">
                      <div className="w-8 h-8 md:w-12 md:h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary font-medium text-[10px] md:text-sm">
                        {t.name.charAt(0)}
                      </div>
                      <div className="flex flex-col">
